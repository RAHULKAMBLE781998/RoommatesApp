...
public class AddsAdapter extends RecyclerView.Adapter<AddsAdapter.AddsHolder> {
    ...
    public AddsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ads_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull AddsHolder holder, int position) {
        ...
        if(currentAdd.getImg1()!= null)
        {
           ...
           // final ImageLoader imageLoader = ImageLoader.getInstance();
            Picasso.get().load(currentAdd.getImg1()).centerCrop().fit().into( holder.img);
